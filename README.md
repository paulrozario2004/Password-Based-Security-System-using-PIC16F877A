...
## 🏗 How It Works
1. 📢 The system prompts the user to enter a **4-digit password**.
2. ⌨️ The user inputs the password via the **4x4 keypad**.
...
4. 🔄 The system runs in a loop, allowing multiple attempts.
